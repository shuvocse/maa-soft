...
public class VoucherDto {
	...
	public VoucherDto(Integer customerId, Integer chainId, Integer machineId, double vori, double ana, double roti,
			double point, double weightReceive, double weightReturn, double estInch, double actInch, double estCutPoint,
			double actCutPoint) {
